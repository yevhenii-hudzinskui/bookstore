...
<div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
        <h1 class="text-3xl font-semibold text-gray-900 leading-6 tracking-tight">@lang('Books :count', ['count' => $books->count()])  </h1>
        <p>@lang( "My age is :age and name is :name", ['age' => 23, 'name' => 'jon'])</p>
        <p>{{ trans_choice('base.apples', 25) }}</p>
